...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full">
  ...
  >
    <div class="flex flex-col min-h-full">
      {{-- Navbar --}}
      <nav
        class="sticky top-0 z-40 w-full border-b border-slate-200 bg-white/50 backdrop-blur dark:border-slate-800 dark:bg-slate-900/80"
      >
        <div
        ...
        >
          ...
          <div class="flex items-center gap-8">
            ...
            >
              ...
              <a
                href="#"
                class="hover:text-orange-500 dark:hover:text-orange-300 {{ request()->routeIs('')? 'text-orange-500 dark:text-orange-300': '' }}"
                >Categories</a
              >
          ...
          <div class="flex items-center gap-4">
            ...
            >
              ...
              <svg
                id="theme-toggle-sun"
                class="hidden h-5 w-5 text-yellow-300/90"
                fill="none"
                viewBox="0 0 24 24"
                stroke-width="2"
                stroke="currentColor"
              >
                <path
                  ...
                  d="M12 3v2.25m0 13.5V21M5.146 5.146l1.591 1.591m9.082 9.082l1.591 1.591M3 12h2.25m13.5 0H21M5.146 18.854l1.591-1.591m9.082-9.082l1.591-1.591M12 6.75a5.25 5.25 0 100 10.5 5.25 5.25 0 000-10.5z"
                />
              </svg>
            ...
            @guest
              <a
                href="{{ route('login') }}"
                class="hover:text-orange-500 dark:hover:text-orange-300 {{ request()->routeIs('login')? 'text-orange-500 dark:text-orange-300': '' }}"
                >Sign in</a
              >
              <a
                href="{{ route('register') }}"
      ...
      >
        <div
          class="container mx-auto px-4 py-6 text-center text-sm text-slate-500 dark:text-slate-400"
        >
