...
<body class="h-full bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-50 font-sans antialiased transition-colors duration-200">

    <div class="flex min-h-full flex-col">
        {{-- Public Navigation Header --}}
        <nav class="sticky top-0 z-40 w-full border-b border-slate-200 bg-white/80 backdrop-blur dark:border-slate-800 dark:bg-slate-900/80">
            <div class="container mx-auto flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
                ...
                <div x-data class="flex items-center gap-4">
                    ...
                    <button id="theme-toggle" class="rounded-lg p-2 text-slate-500 hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-slate-800 focus:outline-none">
                        ...
                        <svg id="theme-toggle-sun" class="hidden h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <svg id="theme-toggle-moon" class="h-5 w-5 dark:hidden" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    {{-- Cart Summary Link --}}
                    <button 
                        x-on:click="$dispatch('cart-updated')" 
                        class="group flex items-center p-2 text-slate-500 dark:text-slate-400 focus:outline-none"
                    >
                        ...
                        <span class="ml-2 text-sm font-medium text-slate-700 dark:text-slate-300 group-hover:text-blue-600 dark:group-hover:text-blue-400">0</span>
                    </button>
    ...
    {{-- Insert cleanly at the bottom of the body layout schema --}}
